...
public class ShortCandleAndMomentumDetectorOld extends AbstractCandleAndMomentumDetector {
	public ShortCandleAndMomentumDetectorOld(double thresholdLevel, boolean pStyleAggressive) {
