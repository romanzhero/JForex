...
public class SmiSmaTradeSetup extends TradeSetup {
	...
	public SmiSmaTradeSetup(IIndicators indicators, IHistory history, IEngine engine, IConsole console, Set<Instrument> subscribedInstruments, boolean mktEntry) {
...
//			console.getOut().println("Short signal at " + FXUtils.getFormatedBarTime(bidBar) 
...
//					+ "; prevSlow: " + FXUtils.df1.format(slowSMI[0][0]));
   ...
   boolean buySignal(double[][] slowSMI, double[][] fastSMI, double ma20, double ma50, double ma100, double ma200, IBar bidBar) {
    ...
    // true means there's a strong uptrend and momentum exits are now switched OFF
