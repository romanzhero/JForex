...
public abstract class ConditionalFilterOnMACDsPosition extends
	...
	public double calcCondFilterValue(Instrument instrument, OfferSide side,
			AppliedPrice appliedPrice, long time) throws JFException {
		double resultTmp[][] = indicators.macd(instrument, condPeriod, side,
