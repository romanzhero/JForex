...
public abstract class ConditionalFilterOnMAsPosition extends
	...
	protected double calcCondFilterValue(Instrument instrument, OfferSide side,
		...
		if (trendDetector.getUptrendMAsMaxDifStDevPos(instrument, period, side,
				appliedPrice, time, 720) != -1000) {
			return 2.0;
		} else if (trendDetector.getDowntrendMAsMaxDifStDevPos(instrument,
				period, side, appliedPrice, time, 720) != -1000) {
			return 0.0;
		} else {
			return 1.0;
		}
