...
public class LongMREntry implements IEntry {
	...
	/* Entry rules are:
	 * 1. 30' bullish trigger deep in the channel
	 * 2. 4h momentum raising: MACD-H not falling below zero, Stochs not falling in the middle
	 * 3. 4h trend flat or falling
	 * 
	 */
	@Override
	...
	private boolean highTimeFrameConditionsOK(Instrument instrument, IBar askBar, IBar bidBar) throws JFException {
		...
		if (!(macdH4h.toString().startsWith("RAISING") || macdH4h.toString().startsWith("TICKED_UP")))
			return false;
