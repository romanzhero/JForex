...
public class IBBridge implements EWrapper {
    ...
    private List<OrderFull> 
    	openOrders = new ArrayList<OrderFull>(),
...
//        m_client.placeOrder( m_orderDlg.m_id, m_orderDlg.m_contract, order );
    ...
    public void openOrder( int orderId, Contract contract, Order order, OrderState orderState) {
        // received open order
    	m_lastMessage = EWrapperMsgGenerator.openOrder(orderId, contract, order, orderState);
    	if (m_tickerToFilter.equals("")) {
        	...
        	if (orderState.m_status.equals("Filled")) {
        		filledOrders.add(new OrderFull(orderId, order, contract, orderState));
        	}
    	}
    	else {
