 ...
 * 
 */
public class OrderTablePlugin extends Plugin implements ITickFeedListener,
		IMessageListener {
	...
	public void onStart(IPluginContext context) throws JFException {
		...
		// subscribe to ticks of those instruments that we have orders from - to
		// follow their price movements
