...
public class BarOHLCElement extends BaseFlexElement implements
		IFlexEmailElement {
	...
	public String print(Instrument instrument, Period pPeriod, IBar bidBar,
		...
		ResultSet elementData = dbGetElementData(instrument, pPeriod, bidBar,
				logDB, "barOpen, barClose, barHigh, barLow", true);
		if (elementData != null) {
			...
			try {
				res += "current price: "
						+ df.format(elementData.getDouble("barClose")) + ", ";
				res += "last bar low: "
				...
				System.out.print("Log database problem in BarOHLCElement: "
						+ e.getMessage());
				System.exit(1);
			}
			return res;
