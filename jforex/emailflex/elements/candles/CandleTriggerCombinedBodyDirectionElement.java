...
public class CandleTriggerCombinedBodyDirectionElement extends BaseFlexElement implements IFlexEmailElement {
...
return new String();
 ...
 public IFlexEmailElement cloneIt() {
  return new CandleTriggerCombinedBodyDirectionElement();
 }
