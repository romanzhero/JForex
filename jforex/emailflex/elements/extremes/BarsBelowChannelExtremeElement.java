package jforex.emailflex.elements.extremes;
...
public class BarsBelowChannelExtremeElement extends BaseFlexElement implements IFlexEmailElement {
...
return new String();
 ...
 public IFlexEmailElement cloneIt() {
  return new BarsBelowChannelExtremeElement();
 }
