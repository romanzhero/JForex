 ...
 * 
 */
public class EMACrossElementSlow extends BaseFlexElement implements
		IFlexEmailElement {
		...
		if (isBullishEMACross(mailStringsMap, mailValuesMap, instrument,
			...
			sqlStr += ", ValueName1, ValueD1) "
					+ SignalUtils.getSignalInsertValues(
							SignalUtils.EMACrossSlowID, FXUtils
	...
	private boolean isBearishEMACross(Map<String, String> mailStringsMap,
		...
		double[] ema50 = indicators
				.ema(instrument, pPeriod, OfferSide.ASK, AppliedPrice.CLOSE,
						50, Filter.WEEKENDS, 2, bidBar.getTime(), 0), ema100 = indicators
				.ema(instrument, pPeriod, OfferSide.ASK, AppliedPrice.CLOSE,
						100, Filter.WEEKENDS, 2, bidBar.getTime(), 0);
		double prevSMA50 = ema50[0], currSMA50 = ema50[1], prevSMA100 = ema100[0], currSMA100 = ema100[1];
	...
	private boolean isBullishEMACross(Map<String, String> mailStringsMap,
		...
		double[] ema50 = indicators
				.ema(instrument, pPeriod, OfferSide.ASK, AppliedPrice.CLOSE,
						50, Filter.WEEKENDS, 2, askBar.getTime(), 0), ema100 = indicators
				.ema(instrument, pPeriod, OfferSide.ASK, AppliedPrice.CLOSE,
