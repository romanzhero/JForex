 ...
 * 
 */
public class SMACrossElementFast extends BaseFlexElement implements
		IFlexEmailElement {
	...
	public String print(Instrument instrument, Period pPeriod, IBar bidBar,
		...
		if (isBullishSMACross(mailStringsMap, mailValuesMap, instrument,
			...
			value = instrument.toString()
					+ ": Bulish SMA cross (MA20 / MA50) trend following signal ! BUY STP: "
					+ df.format(high)
					+ ", ATR "
			...
			sqlStr += ", ValueName1, ValueD1) "
					+ SignalUtils.getSignalInsertValues(
							SignalUtils.SMACrossFastID, FXUtils
	...
	private boolean isBearishSMACross(Map<String, String> mailStringsMap,
		...
		double[] sma20 = indicators
				.sma(instrument, pPeriod, OfferSide.ASK, AppliedPrice.CLOSE,
						20, Filter.WEEKENDS, 2, bidBar.getTime(), 0), sma50 = indicators
				.sma(instrument, pPeriod, OfferSide.ASK, AppliedPrice.CLOSE,
						50, Filter.WEEKENDS, 2, bidBar.getTime(), 0);
		double prevSMA20 = sma20[0], currSMA20 = sma20[1], prevSMA50 = sma50[0], currSMA50 = sma50[1];
	...
	private boolean isBullishSMACross(Map<String, String> mailStringsMap,
		...
		double[] sma20 = indicators
				.sma(instrument, pPeriod, OfferSide.ASK, AppliedPrice.CLOSE,
						20, Filter.WEEKENDS, 2, askBar.getTime(), 0), sma50 = indicators
				.sma(instrument, pPeriod, OfferSide.ASK, AppliedPrice.CLOSE,
