package jforex.emailflex.elements.osob;
...
public class StochStateOverlapElement extends BaseFlexElement implements IFlexEmailElement {
...
return new String();
 ...
 public IFlexEmailElement cloneIt() {
  return new StochStateOverlapElement();
 }
