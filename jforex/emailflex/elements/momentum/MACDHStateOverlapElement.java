package jforex.emailflex.elements.momentum;
...
public class MACDHStateOverlapElement extends BaseFlexElement implements IFlexEmailElement {
...
return new String();
 ...
 public IFlexEmailElement cloneIt() {
  return new MACDHStateOverlapElement();
 }
