...
public class FlexEmailElementFactory {
	...
	static {
		...
		elementMap.put("CandleTriggerChannelPos",
				new CandleTriggerChannelPosElement());
		elementMap.put("CandleTriggerKChannelPos",
				new CandleTriggerKChannelPosElement());
		elementMap.put("PivotLevel", new PivotLevelElement());
		elementMap.put("candleTriggerCombinedBodyDirection",
				new CandleTriggerCombinedBodyDirectionElement());
		elementMap.put("relatedCandlesSameTF",
				new RelatedCandlesSameTFElement());
		...
		elementMap.put("barHighChannelPosOverlap",
				new BarHighChannelPosOverlapElement());
		elementMap.put("barLowChannelPos", new BarLowChannelPosElement());
		elementMap.put("barLowChannelPosOverlap",
				new BarLowChannelPosOverlapElement());
		...
		elementMap.put("barsAboveChannelExtreme",
				new BarsAboveChannelExtremeElement());
		elementMap.put("barsBelowChannelExtreme",
				new BarsBelowChannelExtremeElement());
