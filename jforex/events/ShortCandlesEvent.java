...
public class ShortCandlesEvent implements ITAEvent {
	protected TradeTrigger candles = null;

	public ShortCandlesEvent(IIndicators pIndicators, IHistory pHistory) {
		super();
	...
	public String getName() {
		return new String("ShortCandlesEvent");
	}
	...
	public TAEventDesc checkEvent(Instrument instrument, Period period,	IBar askBar, IBar bidBar, Filter filter) throws JFException {
		TradeTrigger.TriggerDesc signal = candles.bearishReversalCandlePatternDesc(instrument, period, OfferSide.ASK, bidBar.getTime());
		if (signal == null)
			return null;
