...
public class FinancialAdvisorDlg extends JDialog {
	...
	private IBTextPanel profileTextEditor = new IBTextPanel(
			"Allocation Profiles", true);
	...
	public FinancialAdvisorDlg(Frame owner) {
		...
		Dimension editPanelSizeDimension = new Dimension(DIALOG_WIDTH,
				3 * EDITOR_HEIGHT);
	...
	void receiveInitialXML(String p_groupsXML, String p_profilesXML,
			String p_aliasesXML) {
