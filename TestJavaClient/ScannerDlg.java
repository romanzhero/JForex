...
public class ScannerDlg extends JDialog {
	...
	private JTextField m_scanCode = new JTextField(
	...
	public ScannerDlg(SampleFrame owner) {
		...
		addGBComponent(pSubscriptionDetails, new JLabel("Number of Rows"), gbc,
				COL1_WIDTH, GridBagConstraints.RELATIVE);
		addGBComponent(pSubscriptionDetails, m_numberOfRows, gbc, COL2_WIDTH,
				GridBagConstraints.REMAINDER);
		addGBComponent(pSubscriptionDetails, new JLabel("Instrument"), gbc,
				COL1_WIDTH, GridBagConstraints.RELATIVE);
		addGBComponent(pSubscriptionDetails, m_instrument, gbc, COL2_WIDTH,
				GridBagConstraints.REMAINDER);
		addGBComponent(pSubscriptionDetails, new JLabel("Location Code"), gbc,
				COL1_WIDTH, GridBagConstraints.RELATIVE);
		addGBComponent(pSubscriptionDetails, m_locationCode, gbc, COL2_WIDTH,
				GridBagConstraints.REMAINDER);
		addGBComponent(pSubscriptionDetails, new JLabel("Scan Code"), gbc,
				COL1_WIDTH, GridBagConstraints.RELATIVE);
		addGBComponent(pSubscriptionDetails, m_scanCode, gbc, COL2_WIDTH,
				GridBagConstraints.REMAINDER);
		addGBComponent(pSubscriptionDetails, new JLabel("Above Price"), gbc,
				COL1_WIDTH, GridBagConstraints.RELATIVE);
		addGBComponent(pSubscriptionDetails, m_abovePrice, gbc, COL2_WIDTH,
				GridBagConstraints.REMAINDER);
		addGBComponent(pSubscriptionDetails, new JLabel("Below Price"), gbc,
				COL1_WIDTH, GridBagConstraints.RELATIVE);
		addGBComponent(pSubscriptionDetails, m_belowPrice, gbc, COL2_WIDTH,
				GridBagConstraints.REMAINDER);
		addGBComponent(pSubscriptionDetails, new JLabel("Above Volume"), gbc,
				COL1_WIDTH, GridBagConstraints.RELATIVE);
		addGBComponent(pSubscriptionDetails, m_aboveVolume, gbc, COL2_WIDTH,
				GridBagConstraints.REMAINDER);
		addGBComponent(pSubscriptionDetails, new JLabel(
				"Avg Option Volume Above"), gbc, COL1_WIDTH,
				GridBagConstraints.RELATIVE);
		addGBComponent(pSubscriptionDetails, m_averageOptionVolumeAbove, gbc,
				COL2_WIDTH, GridBagConstraints.REMAINDER);
		addGBComponent(pSubscriptionDetails, new JLabel("Market Cap Above"),
				gbc, COL1_WIDTH, GridBagConstraints.RELATIVE);
		addGBComponent(pSubscriptionDetails, m_marketCapAbove, gbc, COL2_WIDTH,
				GridBagConstraints.REMAINDER);
		addGBComponent(pSubscriptionDetails, new JLabel("Market Cap Below"),
				gbc, COL1_WIDTH, GridBagConstraints.RELATIVE);
		addGBComponent(pSubscriptionDetails, m_marketCapBelow, gbc, COL2_WIDTH,
				GridBagConstraints.REMAINDER);
		addGBComponent(pSubscriptionDetails, new JLabel("Moody Rating Above"),
				gbc, COL1_WIDTH, GridBagConstraints.RELATIVE);
		addGBComponent(pSubscriptionDetails, m_moodyRatingAbove, gbc,
				COL2_WIDTH, GridBagConstraints.REMAINDER);
		addGBComponent(pSubscriptionDetails, new JLabel("Moody Rating Below"),
				gbc, COL1_WIDTH, GridBagConstraints.RELATIVE);
		addGBComponent(pSubscriptionDetails, m_moodyRatingBelow, gbc,
				COL2_WIDTH, GridBagConstraints.REMAINDER);
		addGBComponent(pSubscriptionDetails, new JLabel("S & P Rating Above"),
				gbc, COL1_WIDTH, GridBagConstraints.RELATIVE);
		addGBComponent(pSubscriptionDetails, m_spRatingAbove, gbc, COL2_WIDTH,
				GridBagConstraints.REMAINDER);
		addGBComponent(pSubscriptionDetails, new JLabel("S & P Rating Below"),
				gbc, COL1_WIDTH, GridBagConstraints.RELATIVE);
		addGBComponent(pSubscriptionDetails, m_spRatingBelow, gbc, COL2_WIDTH,
				GridBagConstraints.REMAINDER);
		addGBComponent(pSubscriptionDetails, new JLabel("Maturity Date Above"),
				gbc, COL1_WIDTH, GridBagConstraints.RELATIVE);
		addGBComponent(pSubscriptionDetails, m_maturityDateAbove, gbc,
				COL2_WIDTH, GridBagConstraints.REMAINDER);
		addGBComponent(pSubscriptionDetails, new JLabel("Maturity Date Below"),
				gbc, COL1_WIDTH, GridBagConstraints.RELATIVE);
		addGBComponent(pSubscriptionDetails, m_maturityDateBelow, gbc,
				COL2_WIDTH, GridBagConstraints.REMAINDER);
		addGBComponent(pSubscriptionDetails, new JLabel("Coupon Rate Above"),
				gbc, COL1_WIDTH, GridBagConstraints.RELATIVE);
		addGBComponent(pSubscriptionDetails, m_couponRateAbove, gbc,
				COL2_WIDTH, GridBagConstraints.REMAINDER);
		addGBComponent(pSubscriptionDetails, new JLabel("Coupon Rate Below"),
				gbc, COL1_WIDTH, GridBagConstraints.RELATIVE);
		addGBComponent(pSubscriptionDetails, m_couponRateBelow, gbc,
				COL2_WIDTH, GridBagConstraints.REMAINDER);
		addGBComponent(pSubscriptionDetails, new JLabel("Exclude Convertible"),
				gbc, COL1_WIDTH, GridBagConstraints.RELATIVE);
		addGBComponent(pSubscriptionDetails, m_excludeConvertible, gbc,
				COL2_WIDTH, GridBagConstraints.REMAINDER);
		addGBComponent(pSubscriptionDetails,
				new JLabel("Scanner Setting Pairs"), gbc, COL1_WIDTH,
				GridBagConstraints.RELATIVE);
		addGBComponent(pSubscriptionDetails, m_scannerSettingPairs, gbc,
				COL2_WIDTH, GridBagConstraints.REMAINDER);
		addGBComponent(pSubscriptionDetails, new JLabel("Stock Type Filter"),
				gbc, COL1_WIDTH, GridBagConstraints.RELATIVE);
		addGBComponent(pSubscriptionDetails, m_stockTypeFilter, gbc,
				COL2_WIDTH, GridBagConstraints.REMAINDER);
